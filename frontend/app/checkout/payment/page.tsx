...
//   method: "credit-card" | "paypal" | "stripe" | "bank-transfer" | "cash-on-delivery";
//   cardNumber?: string;
//   expiry?: string;
//   cvv?: string;
//   cardName?: string;
...
//     .refine(
//       (val, ctx) => {
//         if (ctx.parent.method === "credit-card") {
//           return val && /^\d{16}$/.test(val.replace(/\s/g, ""));
//         }
//         return true;
//       },
//       {
...
//       (val, ctx) => {
//         if (ctx.parent.method === "credit-card") {
//           return val && /^(0[1-9]|1[0-2])\/?([0-9]{2})$/.test(val);
//         }
//         return true;
//       },
//       {
...
//       }
//     ),
// }) satisfies z.ZodType<PaymentFormValues>;
...
//         const processingData = response.data.results.filter((item: Order) => item.status === 'processing');
        
//         const items: CartItem[] = [];

//         // Define the type for order_item based on expected structure
//         type OrderItem = {
...
//           order.items.forEach((order_item: OrderItem) => {
//             items.push({
//               id: order.id,
//               uniqId: order.uniqId,
...
//         const summary = userOrders.reduce(
...
//       try {
//         const response = await axios.get("/api/api/shipping/", {
//           headers: {
//             Authorization: `Bearer ${session.accessToken}`,
//           },
//         });
